...
![Pipeline public : sources autorisées et imports manuels, normalisation, faits, scoring configurable, SQLite, API locale et interface React.](/assets/proof/job-radar/architecture.webp)
