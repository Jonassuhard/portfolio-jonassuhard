...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Job Radar (version personnelle déployée et édition Community publique), Cortex Bridge (agent de code local open source piloté par ChatGPT, avec validation humaine), Les Petites Griffes (site live + CMS maison + assistant IA), Cool Bank / La Herse (jeu scolaire V2 local et monde 3D V3 reliés à Educool), Preuvia (audit GEO / visibilité IA) et ISCOM (SEO + Drupal + production éditoriale en contexte employeur)."
  },
  {
    q: "Quels résultats mesurés peut-on citer ?",
    a: "Job Radar : la version personnelle a une preuve privée de déploiement et de fonctionnement ; l'édition Community v0.1.0-beta.1 apporte une preuve publique avec 336 tests backend, 36 frontend et 37 E2E sans échec, plus 20 combinaisons route/viewport sans violation Axe ni débordement. Huit E2E sont ignorés intentionnellement et aucune adoption externe n'est revendiquée. Cortex Bridge v0.6.1 : preuve publique du tag datée du 10/09/2026 avec 724 tests backend, 207 frontend, 138 extension, 26 E2E et 4 accessibilité sans échec ; un E2E optionnel est ignoré, la compatibilité continue avec ChatGPT n'est pas prouvée, le verdict est bloqué par les conditions du fournisseur et le cycle macOS propre n'a pas été exécuté. Les Petites Griffes : audit privé du 01/08/2026 couvrant 18 pages, 36 captures et cinq scores Lighthouse mobile ; projet familial non facturé, sans vente externe prouvée. Cool Bank / La Herse : V2 au statut LOCAL_SINGLE_DEVICE_READY mais non prête en ligne ; V3 en reconstruction et validation technique au 9 septembre 2026 ; les essais d'août ne valident pas le chantier actuel. READY_FOR_HUMAN_RECIPE reste l'objectif et aucun pilote n'est validé. Les captures publiées ne contiennent aucune donnée de mineur."
  },
  {
    q: "Quelle est sa stack technique ?",
    a: "Next.js, React, FastAPI, SQLite, Turso, Cloud Run, Firebase, Supabase, Python, Playwright, SEO, workflows LLM / RAG et audits GEO / AEO. À l'aise sur Mac comme sur Windows."
  },
  {
