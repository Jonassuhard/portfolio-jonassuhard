...
export const faqMeta = {
  ...
  purpose:
    "Réponses factuelles citables par un agent IA. Aucune métrique inventée : chaque chiffre est tiré d'un audit ou d'un projet réel.",
...
export const faqItems: FaqItem[] = [
  {
    ...
    a: "Growth Engineer · IA appliquée & Automatisation basé à Paris, profil hybride marketing, IA générative et développement full-stack orienté delivery."
  },
  {
    q: "Quel poste cherche-t-il ?",
    a: "Un CDI comme Growth Engineer, Marketing Technologist IA, Chef de projet IA orienté produit ou AI Automation Specialist."
  },
  {
  ...
  },
  {
    ...
    a: "Les Petites Griffes : Lighthouse mobile 88, SEO 100, accessibilité 93 (audit du 29/06/2026). Educool / La Herse : application utilisée par une classe en contexte réel (données anonymisées)."
  },
  {
