...
export const verificationItems: VerificationItem[] = [
  ...
  },
  {
    ...
    claim: "Cool Bank / La Herse distingue une V2 3D jouable localement sur un appareil et une V3 en reconstruction, sans validation technique globale actuelle.",
    scope: "Projet",
    status: "private-evidence",
    checkedAt: "2026-09-09",
    note: "Lecture des sources privées du 9 septembre : les essais V2 du 22 août et V3 du 26 août restent historiques. Le chantier V3 de septembre vise une nouvelle candidate technique avant recette humaine. Aucune nouvelle exécution du jeu, aucun pilote ni résultat pédagogique ne sont revendiqués."
  },
  {
