...
export const verificationItems: VerificationItem[] = [
  ...
  },
  {
    ...
    claim: "La preuve Job Radar Community v0.1.0-beta.1 rapporte 234 tests backend, 30 tests frontend et 37 tests E2E sans échec ; 8 scénarios E2E sont ignorés intentionnellement. Elle couvre 20 combinaisons route/viewport sans violation Axe ni débordement.",
    scope: "Projet",
    status: "publicly-verified",
    checkedAt: "2026-08-27",
    ...
    note: "Preuve publique d'une validation locale datée sur un corpus de 42 offres fictives. Elle ne prouve ni adoption externe, ni candidature obtenue, ni exécution GitHub Actions."
  },
  {
