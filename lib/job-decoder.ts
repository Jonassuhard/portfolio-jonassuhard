...
const PROFILE_EVIDENCE: Record<string, Omit<EvidenceMatch, "id" | "label">> = {
  ...
  "security-governance": { coverage: "partial", project: { label: "Educool", href: "/projets/educool-la-herse" }, note: "Garde-fous sur données sensibles, sans fonction de conformité formelle." },
